...
export interface Location {
  id: number;
  name: string;
  category: 'beaches-north' | 'beaches-south' | 'beaches-town' | 'dining' | 'adventures' | 'adventures-regional' | 'logistics' | 'car-rentals' | 'golf';
  query: string;
  tags: string[];
  description: string;
  intel: string;
...
export const locations: Location[] = [
  ...
  // SOUTHERN BEACHES
  {
    ...
    tags: ["Survivor Site", "Rugged", "Rock Formations", "Non-touristy"],
    description: "A rugged, non-touristy beach 4km south of town with a massive rock formation. Famous as a Survivor filming location.",
    intel: "Features a prominent 75m rock formation in the sea. Great for escaping town crowds and having a bay to yourself.",
  ...
  },
  {
    ...
    rating: 4.8,
    priceRange: '$$',
    website: "https://www.playahermosabeachhotel.com/",
    images: [
  ...
  },
  {
    ...
    tags: ["Turtle Nursery", "Eco-Retreat", "Off-grid", "Vital Actions"],
    description: "Home to the Vital Actions turtle nursery and off-grid eco-retreats. A hub for conservation.",
    intel: "A hub for conservation. Follow Vital Actions on Instagram for 20-30 minute notice on turtle releases.",
    tips: ["Support Vital Actions", "Check Instagram stories for release alerts", "Great for eco-conscious travelers"],
    icon: TreePine,
    rating: 4.7,
    priceRange: '$$',
    images: [
  ...
  // DINING
  {
    ...
    rating: 4.6,
    priceRange: '$$',
    website: "https://www.facebook.com/dalepuessjds/",
    images: [
  ...
  },
  {
    ...
    rating: 4.7,
    priceRange: '$$',
    website: "https://www.facebook.com/dingrepaircafe/",
    images: [
  ...
  },
  {
    ...
    rating: 4.4,
    priceRange: '$$$',
    website: "https://www.facebook.com/eltimonsjds/",
    images: [
...

  {
    ...
    rating: 4.9,
    priceRange: '$$$$',
    website: "https://www.morgansrock.com/",
    images: [
  ...
  },
  {
    ...
    rating: 4.7,
    priceRange: '$$$',
    website: "https://treecasaresort.com/",
    images: [
  ...
  },
  {
    ...
    rating: 5.0,
    priceRange: '$',
    website: "https://www.vitalactions.org/",
    images: [
  ...
  {
    id: 55,
    name: "Guacalito de la Isla",
    category: "golf",
    query: "Guacalito+de+la+Isla+Golf",
    tags: ["Luxury", "18-Hole", "Ocean View"],
    description: "David McLay Kidd designed course featuring the famous 18th hole on the beach.",
    intel: "One of the best courses in Central America. The 18th hole is literally on the sand.",
    tips: ["Book in advance", "Dress code enforced", "Sunset golf is spectacular"],
    icon: Flag,
    rating: 4.9,
    priceRange: '$$$$',
    website: "https://www.guacalitodelaisla.com",
    images: [
      "https://loremflickr.com/800/600/golf,course,ocean",
      "https://loremflickr.com/800/600/golf,green",
      "https://loremflickr.com/800/600/luxury,resort,golf"
    ],
    coordinates: { lat: 11.3650, lng: -85.9050 },
    hours: {
      open: "7:00 AM",
      close: "5:00 PM",
      days: "Daily"
  ...
  {
    id: 56,
    name: "Hacienda Iguana Golf",
    category: "golf",
    query: "Hacienda+Iguana+Golf+Club",
    tags: ["9-Hole", "Casual", "Community"],
    description: "A challenging 9-hole course set within the Hacienda Iguana gated community.",
    intel: "Great for a quick round. Very friendly atmosphere and well-maintained greens.",
    tips: ["Watch out for the water hazards", "Great 19th hole at Pili's", "Rent a cart"],
    icon: Flag,
    rating: 4.5,
    priceRange: '$$',
    website: "https://www.haciendaiguana.com",
    images: [
      "https://loremflickr.com/800/600/golf,fairway",
      "https://loremflickr.com/800/600/golf,clubhouse",
      "https://loremflickr.com/800/600/tropical,golf"
    ],
    coordinates: { lat: 11.4150, lng: -86.0150 },
    hours: {
      open: "7:30 AM",
      close: "5:30 PM",
      days: "Daily"
  ...
  // CAR RENTALS
  {
    ...
    rating: 4.8,
    priceRange: '$$$',
    website: "https://www.gabyscarrental.com/",
    images: [
  ...
  {
    id: 60,
    name: "Machete Market Cafe",
    category: "dining",
    query: "Machete+Market+Cafe+San+Juan+del+Sur",
    tags: ["Artisanal", "Organic", "Pizza Night"],
    description: "A community hub on the road to Playa Maderas known for artisanal organic products.",
    intel: "Famous for its Friday Pizza Night. A local secret for high-quality organic goods.",
    tips: ["Don't miss Friday Pizza Night", "Great for organic supplies", "Located on Maderas road"],
    icon: Coffee,
    rating: 4.8,
    priceRange: '$$',
    images: [
      "https://loremflickr.com/800/600/organic,cafe",
      "https://loremflickr.com/800/600/artisanal,pizza",
      "https://loremflickr.com/800/600/community,hub"
    ],
    coordinates: { lat: 11.2850, lng: -85.8950 },
    hours: { open: "8:00 AM", close: "4:00 PM", days: "Tue-Sun" }
  },
  {
    id: 61,
    name: "Saturday Farmer's Market",
    category: "dining",
    query: "Big+Wave+Dave's+San+Juan+del+Sur",
    tags: ["Local Market", "Expat Hub", "Organic"],
    description: "The primary spot for expats to buy smoked meats, fresh organic greens, and homemade baked goods.",
    intel: "Held at Big Wave Dave’s (formerly Buen Gusto) every Saturday morning.",
    tips: ["Saturday only: 9:30 AM - 12:00 PM", "Go early for the best selection", "Try the smoked meats"],
    icon: Utensils,
    rating: 4.7,
    priceRange: '$$',
    images: [
      "https://loremflickr.com/800/600/farmers,market",
      "https://loremflickr.com/800/600/organic,vegetables",
      "https://loremflickr.com/800/600/baked,goods"
    ],
    coordinates: { lat: 11.2530, lng: -85.8710 },
    hours: { open: "9:30 AM", close: "12:00 PM", days: "Saturday" }
  },
  {
    id: 62,
    name: "The Lighthouse & Hidden Fortress",
    category: "adventures",
    query: "San+Juan+del+Sur+Lighthouse",
    tags: ["Hiking", "History", "Panoramic Views"],
    description: "A steep one-hour hike leading to a small white lighthouse and military ruins.",
    intel: "Starts near the fish market (Acopio). Offers incredible views overlooking the Pacific.",
    tips: ["Wear sturdy shoes", "Bring plenty of water", "Start early to avoid heat"],
    icon: Mountain,
    rating: 4.6,
    priceRange: '$',
    images: [
      "https://loremflickr.com/800/600/lighthouse,ocean",
      "https://loremflickr.com/800/600/military,ruins",
      "https://loremflickr.com/800/600/hiking,trail"
    ],
    coordinates: { lat: 11.2480, lng: -85.8780 }
  },
  {
    ...
    name: "Bottoms Up",
    category: "dining",
    query: "Bottoms+Up+San+Juan+del+Sur",
    tags: ["Best Pool", "Community", "Bar"],
    description: "A favorite spot known for having the 'best pool in town' and a welcoming vibe.",
    intel: "Great alternative to the beach for a relaxing afternoon by the pool.",
    tips: ["Bring your swimsuit", "Great community atmosphere", "Try the cocktails"],
    icon: Beer,
    rating: 4.5,
    priceRange: '$$',
    images: [
      "https://loremflickr.com/800/600/swimming,pool,bar",
      "https://loremflickr.com/800/600/cocktail,poolside",
      "https://loremflickr.com/800/600/social,gathering"
    ],
    coordinates: { lat: 11.2550, lng: -85.8680 }
  },
  {
    id: 64,
    name: "Masaya Volcano (Night Tour)",
    category: "adventures-regional",
    query: "Masaya+Volcano+Nicaragua",
    tags: ["Volcano", "Lava", "Night Tour"],
    description: "One of the few places in the world where you can see the glow of molten lava at night.",
    intel: "Roughly a 2-hour drive from SJDS. You can drive right to the edge of the active crater.",
    tips: ["Book a night tour", "2-hour drive from town", "Check volcanic activity status"],
    icon: Mountain,
    rating: 4.9,
    priceRange: '$$$',
    images: [
      "https://loremflickr.com/800/600/volcano,lava",
      "https://loremflickr.com/800/600/night,crater",
      "https://loremflickr.com/800/600/magma,glow"
    ],
    coordinates: { lat: 11.9840, lng: -86.1610 }
  },
  {
    id: 65,
    name: "Las Salinas Hot Springs",
    category: "adventures-regional",
    query: "Las+Salinas+Hot+Springs+Nicaragua",
    tags: ["Hot Springs", "Volcanic", "Rustic"],
    description: "Rustic sulphurous pools in a neighborhood setting with volcanic waters.",
    intel: "Located about 1.5 hours north near Popoyo. Entry is typically around $3.",
    tips: ["Entry fee: ~$3", "1.5 hours north of SJDS", "Rustic and authentic experience"],
    icon: Activity,
    rating: 4.4,
    priceRange: '$',
    images: [
      "https://loremflickr.com/800/600/hot,springs",
      "https://loremflickr.com/800/600/volcanic,water",
      "https://loremflickr.com/800/600/rustic,spa"
    ],
    coordinates: { lat: 11.4850, lng: -86.1150 }
  },
  {
    id: 66,
    name: "Laguna de Apoyo",
    category: "adventures-regional",
    query: "Laguna+de+Apoyo+Nicaragua",
    tags: ["Crater Lake", "Swimming", "Kayaking"],
    description: "A massive volcanic crater lake with thermally heated, crystal clear water.",
    intel: "1.5–2 hours away. Ideal for a day of kayaking and swimming far from the salt and surf.",
    tips: ["1.5-2 hour drive", "Crystal clear water", "Rent a kayak for the day"],
    icon: Waves,
    rating: 4.8,
    priceRange: '$$',
    images: [
      "https://loremflickr.com/800/600/crater,lake",
      "https://loremflickr.com/800/600/clear,water,lake",
      "https://loremflickr.com/800/600/kayak,lake"
    ],
    coordinates: { lat: 11.9250, lng: -86.0350 }
  },
  {
    id: 67,
    name: "Granada & The Islets",
    category: "adventures-regional",
    query: "Granada+Nicaragua",
    tags: ["Colonial City", "History", "Boat Tour"],
    description: "A historic colonial city with catacombs and 365 islets in Lake Nicaragua.",
    intel: "1.5-hour drive. Tour the San Francisco Convent catacombs or take a boat through the islets.",
    tips: ["1.5 hour drive", "Visit the catacombs", "Take a boat tour of the islets"],
    icon: Compass,
    rating: 4.7,
    priceRange: '$$',
    images: [
      "https://loremflickr.com/800/600/colonial,city",
      "https://loremflickr.com/800/600/lake,islets",
      "https://loremflickr.com/800/600/catacombs"
    ],
    coordinates: { lat: 11.9300, lng: -85.9560 }
  },
  {
    id: 68,
    name: "6-Seater Side-by-Side Rental",
    category: "car-rentals",
    query: "Side-by-side+rental+San+Juan+del+Sur",
    tags: ["Group Adventure", "Off-road", "UTV"],
    description: "Rugged 6-seater side-by-side vehicles perfect for group explorations of remote trails.",
    intel: "Ideal for the rugged roads south (Yankee, Escameca). Much safer and more comfortable for groups than multiple ATVs.",
    tips: ["Seats up to 6 people", "Perfect for southern trails", "Book in advance"],
    icon: Truck,
    rating: 4.9,
    priceRange: '$$$$',
    images: [
      "https://loremflickr.com/800/600/utv,sidebyside",
      "https://loremflickr.com/800/600/offroad,group",
      "https://loremflickr.com/800/600/rugged,vehicle"
    ],
    coordinates: { lat: 11.2535, lng: -85.8715 },
    menu: {
      sections: [
        {
          ...
          items: [
            { name: "Full Day (8 Hours)", price: "$150", description: "Includes helmets and full tank" },
            { name: "Half Day (4 Hours)", price: "$90", description: "Perfect for a quick beach trip" },
            { name: "Weekly Rate", price: "$850", description: "Best for long-term exploration" }
          ]
        }
      ]
    }
